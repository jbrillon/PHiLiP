...
{
    double integrated_deviatoric_strain_rate_tensor_magnitude_sqr;
    if(based_on_low_order_solution) integrated_deviatoric_strain_rate_tensor_magnitude_sqr = this->integrated_quantities_low_order_solution[IntegratedQuantitiesEnum::deviatoric_strain_rate_tensor_magnitude_sqr];
    else integrated_deviatoric_strain_rate_tensor_magnitude_sqr = this->integrated_quantities[IntegratedQuantitiesEnum::deviatoric_strain_rate_tensor_magnitude_sqr];
...
{
    double integrated_strain_rate_tensor_magnitude_sqr;
    if(based_on_low_order_solution) integrated_strain_rate_tensor_magnitude_sqr = this->integrated_quantities_low_order_solution[IntegratedQuantitiesEnum::strain_rate_tensor_magnitude_sqr];
    else integrated_strain_rate_tensor_magnitude_sqr = this->integrated_quantities[IntegratedQuantitiesEnum::strain_rate_tensor_magnitude_sqr];
